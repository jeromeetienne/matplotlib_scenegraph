...
class RendererMeshPhongMaterialTexture:
    # =============================================================================
    #
    # =============================================================================
    @staticmethod
    def render(
        ...
        for face_index, (face_vertices_2d, face_uvs, light_intensity, face_visible, face_depth) in enumerate(
            ...
            RendererMeshPhongMaterialTexture.update_textured_face(
    ...
    def update_textured_face(
        ...
        matrix_wrap = RendererMeshPhongMaterialTexture.texture_coords_wrap(face_uvs, face_vertices_2d)
